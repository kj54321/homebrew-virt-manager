class VirtManager < Formula
  ...
  depends_on "dbus" => "with-python3"
  depends_on "gnome-icon-theme" => "with-python3"
  depends_on "gtk+3" => "with-python3"
  depends_on "gtk-vnc" => "with-python3"
  depends_on "hicolor-icon-theme" => "with-python3"
  depends_on "libosinfo" => "with-python3"
  depends_on "libvirt" => "with-python3"
  depends_on "libvirt-glib" => "with-python3"
  depends_on "libxml2" => "with-python3"
  depends_on "pygobject3" => "with-python3"
  depends_on "spice-gtk" => "with-python3"
  depends_on "vte3" => "with-python3"
  depends_on :x11
  # TODO: audio
